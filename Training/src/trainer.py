...
class Trainer:
    ...
    def __init__(self, model, train_dataset, test_dataset, config):
        ...
        if torch.cuda.is_available(): # take over whatever gpus are on the system
            ...
            self.model = torch.nn.DataParallel(self.model).to(self.device)     # For GPU parallel computing

    # Used for saving trained models as files (in train.py)
    ...
    def train(self):
        ...
        optimizer = raw_model.configure_optimizers(config)                      # return torch.optim.Adam optimizer
        ...
        def run_epoch(split):
            ...
            for it, (x, y) in pbar:
                ...
                if is_train: # backprop and update the parameters                    
                    ...
                    # renew parameters of optimizers
                    optimizer.step()
        ...
        while True:
            ...
            for epoch in range(config.max_epochs):
                ...
                # Save Model if reach data frequency   
